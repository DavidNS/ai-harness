...
## Role
Produce only the bounded test phase result.

## Required Inputs
Use only validated spec.md, design.md, one task, changes, and controller command evidence.
...
- the normal `tests.md` artifact candidate required by the phase prompt;
