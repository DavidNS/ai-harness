...
## Role
Produce only the bounded spec phase result.

## Required Inputs
Use only validated explore/outcome_bundle.json, purpose.md, and explorer_scope.
...
- the normal `spec.md` artifact candidate required by the phase prompt;
