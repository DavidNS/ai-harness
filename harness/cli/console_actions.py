...
CONSOLE_ACTIONS: tuple[ConsoleAction, ...] = (
    ConsoleAction("status", "Show status", "s"),
    ConsoleAction("runs", "Show live runs", "r"),
    ConsoleAction("resume", "Resume run", "u"),
    ConsoleAction("archive", "Archive run", "a"),
    ConsoleAction("start", "Start request", "n", ("new",)),
    ConsoleAction("sdd", "Start full SDD", "f"),
    ConsoleAction("explore", "Run explore bundle", "e"),
    ConsoleAction("proposal", "Run proposal bundle", "o"),
    ConsoleAction("spec", "Run spec bundle", "w"),
    ConsoleAction("design", "Run design bundle", "d"),
    ConsoleAction("tasks", "Run tasks bundle", "t"),
    ConsoleAction("tdd", "Run TDD bundle", "l"),
    ConsoleAction("artifacts", "List run artifacts", "v", menu_visible=False),
    ...
    ConsoleAction("install-ci", "Install CI", "c"),
    ConsoleAction("install-packages", "Install packages", "p", ("packages",)),
